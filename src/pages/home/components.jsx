const GradientButton = ({ link = "#", text = "Star on Github" }) => {
  return (
    <div className="flex items-center gap-2">
      <div className="relative animate-fade-in overflow-hidden rounded-full bg-gradient-to-b _from-light-300 _to-light-400 p-[2px] _dark from-dark-300 _dark to-dark-400">
        <div className="gradient-border absolute inset-0 animate-border-spin" />

        <div className="relative z-20 rounded-full bg-light-50_dark bg-dark-50">
          <a
            href={link}
            rel="noopener noreferrer"
            target="_blank"
            className="flex items-center gap-2 px-4 py-1 text-center text-xs text-light-1000_dark text-dark-1000 lg:text-sm"
          >
            {text}
            <svg
              stroke="currentColor"
