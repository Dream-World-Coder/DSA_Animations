          ...
          <div className="container mx-auto max-w-4xl">
            ...
            >
              <div className="w-full flex items-center justify-center gap-2 mb-4">
                <GradientButton
                  link="https://github.com/Dream-World-Coder/DSA_Animations"
                  text="Star on Github"
                />
              </div>
                      ...
                      {category.dropdownElements.map((algo, algoIndex) => (
                        ...
                        >
                          ...
                          <div className="relative z-10">
                            ...
                            <div className="flex items-center text-green-400 text-sm font-medium transition-all duration-300">
                              <Play size={14} />
                              <span className="group-hover:pl-2 duration-300">
                                Animate
                              </span>
                              <ChevronRight
                                size={14}
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              <div>
                ...
                <p className="mb-4">
                  ...
                  you are in the right place. This platform features animations
                  of beautiful algorithms related to Data Structures and
                  Algorithms. I hope these help you grasp things better!
                  <br />
                  Of course, the world of algorithms is vast and fascinating —
                  far beyond what one person can animate alone. So if you're
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center mb-12">
              {[
                ...
                <a
                  key={idx}
                  href={i.href}
                  className="group flex items-center gap-3 bg-neutral-800 hover:bg-neutral-700 px-6 py-3 rounded-lg transition-all duration-300"
                >
                  <i.Icon size={20} className="text-green-400" />
                  <span>{i.text}</span>
                  <ExternalLink
                    size={16}
          ...
          <div className="container mx-auto max-w-6xl">
            <div className="flex flex-col md:flex-row justify-between items-center">
              <div className="mb-4 md:mb-0">
                <p className="text-neutral-400">
                  © 2025 DSA Animations. Made with{" "}
                  <span className="inline-block transform rotate-[270deg]">
                    {"<3"}
                  </span>{" "}
                  for learners.
                </p>
